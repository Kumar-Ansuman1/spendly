...
2. `feauture_title`- human readable title in TITLE Case
    - Example: "Registration" or "Login and Logout"

3. `feauture-slug` - file safe slug
...
- All file in .claude/specs/ - avoid duplicating existing specs

Check CLAUDE.md to confirm the requested steps is not already marked complete. If it is, warn the user and stop.
...
then enter Plan Mode with Shift+Tab twice to begin implementaion."
