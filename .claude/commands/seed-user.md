...
1. Generates a realistic random Indian user using your own knowledge of commom indian names across regions:
- Name: a realistic Indian first + last name
- Email : derived from the nmae with a random 2-3 digit
          number suffix (e.g. rahulsharma91@gmail.com)
...
3. Insert the users into the database using the same get_db() pattern found in db.py.
