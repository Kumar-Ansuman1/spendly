---
description: Seed realistic dummy expenes for a specific user.
...
- month - integer, how many past months to spread them across

If any argument is missing or not valid integer, stop and say:
...
Before generating anything, confirm the user_id exists in the user table. If not, stop and say: "No user found with id <user_id>
...
2. Uses these catagories with realistic Indian description and amounts(₹):
   - Food: 50-800
   - Transport: 20-500
   - Bills: 200-3000
   - Health: 100-2000
   ...
   - Shopping: 200-5000
   - Other: 50-1000
3. Distribute catagories roughly proportionally(Food most common, Health and Entertainment least)
