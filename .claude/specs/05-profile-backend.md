...
## Definition of done
- [x] Logging in as the seed user shows "Demo User" and "demo@spendly.com" on the profile page from database
- [x] Total spent displayed on the profile page equals actual sum from database (₹565.5)
- [x] Transaction count displayed is 8
- [x] Top category displayed is "Shopping" (highest total)
...
- [x] Registering a brand-new user and visiting `/profile` shows ₹0.00 total spent, 0 transactions, and empty category breakdown — no errors